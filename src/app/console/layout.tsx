...
import { Siren, MailQuestion, Bot, Users, BarChart3, SquarePlus, BookOpen, Megaphone } from 'lucide-react';
...
const menus = [
  ...
  { label: '푸쉬 알림', href: '/console/push', icon: <Megaphone   size={20} /> },
  { label: '퀴즈 관리', href: '/console/quiz', icon: <BookOpen size={20} /> },
